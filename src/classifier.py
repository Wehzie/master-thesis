...
class Classifier:
    ...
    def __init__(self,
        ...
        mp: bool = const.MULTIPROCESSING) -> None:
        self.mp = mp
        assert len(awa_list) == len(train_targets), "number of trained ensembles doesn't match the number of training targets"
...
if __name__ == "__main__":
    ...
    difficult_sine = shared_params_target.select_target_by_string("sine", generator_args, synth_freq + 1000)
