...
py_rand_args_uniform = party.PythonSignalRandArgs(
    ...
    weight_dist = dist.WeightDist(RNG.uniform, low=0, high=10, n=N_OSCILLATORS),   # scale down when <1 and scale up when >1
...
phase_sweep = sweety.PhaseSweep(parameter_builder.append_normal([
